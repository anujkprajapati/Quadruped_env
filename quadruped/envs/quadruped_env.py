...
class QuadrupedEnv(gym.Env):
    ...
    def step(self, action, n_step):
        ...
        h1x, h2x, h3x, h4x, h1z, h2z, h3z, h4z = Path.get_location(left,n_step,count,posx)
        ...
        # rpos = (posz-cgz)**2
        rvel = velx if velx !=0 else 0-n_step   #to avoid getting stuck
        ...
        # check if done
        if posz <= 0.1 or n_step>=10000 or r_ori>=0.04:
            self.done = True
